      ...
      <div className="bg-card w-full max-w-md rounded-3xl shadow-xl overflow-hidden border border-border-color">
        <div className="p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              type="submit"
              className="w-full py-3 bg-primary text-card font-bold rounded-xl shadow-md hover:bg-accent hover:shadow-lg transition-all flex items-center justify-center gap-2 group"
            >
