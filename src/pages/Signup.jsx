...
const Signup = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center p-4">
      <div className="bg-card w-full max-w-lg rounded-3xl shadow-xl overflow-hidden border border-border-color">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">Join LocalOffers to save more everyday</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <button 
              type="submit"
              className="mt-6 w-full py-3 bg-accent text-card font-bold rounded-xl shadow-md hover:bg-primary hover:shadow-lg transition-all flex items-center justify-center gap-2 group"
            >
          ...
          <button 
            ...
            className="mt-6 w-full py-3 bg-background border border-border-color text-text-primary font-bold rounded-xl hover:bg-gray-100 transition-all flex items-center justify-center gap-3"
          >
